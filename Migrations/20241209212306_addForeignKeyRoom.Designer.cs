...
namespace real_time_chat_web.Migrations
{
    ...
    [Migration("20241209212306_addForeignKeyRoom")]
    partial class addForeignKeyRoom
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("real_time_chat_web.Models.Messages", b =>
                {
                    ...
                    b.HasOne("real_time_chat_web.Models.Rooms", null)
                        .WithMany("Messages")
                        .HasForeignKey("RoomsIdRooms");
            ...
            modelBuilder.Entity("real_time_chat_web.Models.Rooms", b =>
                {
                    ...
                    b.HasOne("real_time_chat_web.Models.Messages", "messages")
                        .WithMany()
